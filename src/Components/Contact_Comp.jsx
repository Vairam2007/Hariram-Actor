    ...
    <>
      <div id='Contact' className="bg-gray-500 w-full min-h-[100vh] p-[50px] flex justify-center items-center">
        <div className="w-[90%] h-[80%] p-[50px] bg-gray-700 gap-[30px] flex flex-col justify-center items-center ">
          ...
          <div data-aos="fade-out" data-aos-delay='200' className="min-w-[80%] p-[10px] rounded-[20px] bg-gray-400 md:flex-row  flex-col flex gap-[30px] justify-between items-center">
          ...
          <div data-aos="fade-out" data-aos-delay='600' className=" min-w-[80%] p-[10px] rounded-[20px] bg-gray-400 md:flex-row flex-col flex gap-[30px] justify-between items-center">
