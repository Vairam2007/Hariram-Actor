...
const Navbar = () => {
  ...
  return (
    <>
    <div className="w-full h-[10vh] bg-gray-900 flex justify-around text-white overflow-x-hidden">
    ...
    {open &&<div className="w-full min-h-[10vh] md:hidden flex justify-center items-center  ">
